...
begin
  InvoicesList.FrmInvoices.Caption := 'Nuevo';
  InvoicesList.FrmInvoices.Show;
end;

procedure TFrmInvoice.Button3Click(Sender: TObject);
begin
  InvoicesList.FrmInvoices.Caption := 'Editar';
  InvoicesList.FrmInvoices.Hint := DataModule2.CDSFacturanumero.AsString;
  InvoicesList.FrmInvoices.Show;
end;

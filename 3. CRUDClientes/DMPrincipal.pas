...
begin
  ...
  InvoicesList.FrmInvoices.Edit1.Text := FormatFloat('$###,###,###.#0', CDSCabezaFacturatotal.AsFloat);
end;

procedure TDataModule2.CDSDetalleFacturaBeforePost(DataSet: TDataSet);
begin
  CDSCabezaFacturatotal.AsFloat := StrToInt(CDSDetalleFacturacantidad.AsString) * CDSDetalleFacturavalor.AsFloat;
